...
model.save(modelpath + '/fashion_model.h5')
...
model.fit(x_train, y_train, batch_size = 500, epochs=60, validation_split=0.4, callbacks=[early, check])

model.save_weights(modelpath + '/fashion_weights.h5')
