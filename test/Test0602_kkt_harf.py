...
pca = PCA(pca_shape)
hite_x = pca.fit_transform(hite_x)
...
hite_split = hite_x[(time_step-1):510,:]
...
## 모델
input1 = Input(shape = (hite_x_train.shape[1],))
lstm1 = Dense(128)(input1)
...
lstm2 = LSTM(256, activation='elu')(input2)
