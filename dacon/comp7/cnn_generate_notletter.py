...
conv1 = Conv2D(128,(5,5),padding='same')(conv1)
conv1 = LeakyReLU()(conv1)
conv1 = BatchNormalization()(conv1)
conv1 = Conv2D(128,(2,2),padding='same')(conv1)
conv1 = LeakyReLU()(conv1)
...
conv1 = BatchNormalization()(conv1)
conv1 = Conv2D(256,(2,2),padding='same')(conv1)
conv1 = LeakyReLU()(conv1)
conv1 = BatchNormalization()(conv1)
conv1 = Conv2D(256,(2,2),padding='same')(conv1)
conv1 = LeakyReLU()(conv1)
...
conv1 = BatchNormalization()(conv1)
conv1 = Dense(1000, activation='relu')(conv1)
...
reduction = ReduceLROnPlateau(monitor='val_acc', patience=5, verbose=1, factor=0.5, min_lr=0.000001)
