...
for thresh in thresholds:
    ...
    selection_model = RandomizedSearchCV(XGBClassifier(), xgb_parameter, n_jobs=-1, cv = 5, n_iter=1)
...
for thresh in thresholds:
    ...
    selection_model = RandomizedSearchCV(LGBMClassifier(), lgbm_parameter, n_jobs=-1, cv = 5, n_iter=1)
...
import joblib
joblib.dump(best_model, './model/lgbm_Save/sfm2-'+str(best_score)+'.dat')
model2 = joblib.load('./model/lgbm_Save/sfm2-'+str(best_score)+'.dat')
