...
print('Log Mel Spectrogram example: ', len(input_batch))
print('Log Mel Spectrogram example: ', len(input_batch[0]))
print('Log Mel Spectrogram example: ', len(input_batch[0][0]))
