...
def build_model(drop=0.5, optimizer='adam', activations = 'relu'):
    inputs = Input(shape=(x_train.shape[1], x_train.shape[2]))
    lstms = LSTM(128, activation=activations, name = 'hidden1_LSTM')(inputs)

    denses = Dense(512, activation=activations, name='hidden1')(lstms)
...
def create_hyperparameters():
    ...
    return {"batch_size" : batches, "optimizer": optimizers, "drop" : dropout , "activations" : activation}
