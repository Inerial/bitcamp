...
dense1_2 = Dense(115, activation='relu', name="left-input2")(dense1_1)
dense1_3 = Dense(15, activation='relu', name="left-input3")(dense1_2)
...
dense2_3 = Dense(15, activation='relu', name="right-input3")(dense2_2)
dense2_4 = Dense(15, activation='relu', name="right-input4")(dense2_3)
...
middle1 = Dense(15, name="middle2")(middle1)
middle1 = Dense(17, name="middle3")(middle1)


output1_1 = Dense(130, name="left-output1")(middle1)
output1_2 = Dense(17, name="left-output2")(output1_1)
output1_3 = Dense(2, name="left-output3")(output1_2)

output2_1 = Dense(130, name="middle-output1")(middle1)
output2_2 = Dense(17, name="middle-output2")(output2_1)
output2_3 = Dense(2, name="middle-output3")(output2_2)

output3_1 = Dense(130, name="right-output1")(middle1)
output3_2 = Dense(17, name="right-output2")(output3_1)
